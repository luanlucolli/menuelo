...
export const publicFieldFocusRing = 'focus-visible:border-[var(--color-brand)] focus-visible:outline-[3px] focus-visible:outline-[color-mix(in_srgb,var(--color-brand)_22%,transparent)] focus-visible:outline-offset-2'
...
export const checkField = `flex min-h-[44px] items-center gap-[.55rem] text-[.8rem] font-[650] text-text ${focusRing}`
