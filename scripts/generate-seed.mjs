...
const statements = [
  ...
  "INSERT INTO business_settings (id, name, slug, description, timezone, theme, primary_color) VALUES (1, 'Lanchonete de demonstração', 'lanchonete-de-demonstracao', 'Este conteúdo existe apenas para facilitar os testes locais.', 'America/Sao_Paulo', 'classic', '#374151') ON CONFLICT(id) DO UPDATE SET name=excluded.name, slug=excluded.slug, slogan=NULL, description=excluded.description, whatsapp=NULL, phone=NULL, instagram_url=NULL, facebook_url=NULL, address=NULL, maps_url=NULL, timezone=excluded.timezone, special_message=NULL, cover_image_key=NULL, public_site_url=NULL, seo_title=NULL, seo_description=NULL, address_postal_code=NULL, address_street=NULL, address_number=NULL, address_complement=NULL, address_neighborhood=NULL, address_city=NULL, address_state=NULL, theme=excluded.theme, primary_color=excluded.primary_color, updated_at=strftime('%Y-%m-%dT%H:%M:%fZ', 'now');",
